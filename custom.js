        ...
        submitHandler: function ($form) {
          ...
          jQuery.ajax({
            ...
            success: function (data) {
              if (data.success) {
                jQuery(".msg").removeClass("msg-error");
                jQuery(".msg").addClass("msg-success");
                jQuery(".msg").text("Thank You, Your Message Has been Sent");
              } else {
                jQuery(".msg").removeClass("msg-success");
                jQuery(".msg").addClass("msg-error");
                jQuery(".msg").text(
